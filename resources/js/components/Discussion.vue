<template>
    <div class="fs-editor">
        <div class="form-row">
             <div class="checkbox-wrap m-r-10">
                <input type="radio" id="post_status_published" name="post_status" value="active" v-model="postStatus" checked>
                <!-- CHECKBOX BOX -->
                <div class="checkbox-box round"></div>
                <!-- /CHECKBOX BOX -->
                <label class="accordion-trigger-linked" for="post_status_published">Active</label>

             </div>
            <!-- /CHECKBOX WRAP -->
            <!-- CHECKBOX WRAP -->
            <div class="checkbox-wrap">
                <input type="radio" id="post_status_draft" name="post_status" value="inactive" v-model="postStatus">
                <!-- CHECKBOX BOX -->
                <div class="checkbox-box round"></div>
                <!-- /CHECKBOX BOX -->
                <label class="accordion-trigger-linked" for="post_status_draft">Closed</label>
            </div>
            <!-- /CHECKBOX WRAP -->
        </div>
        <div class="form-row">
            ...
            editor.save()
                .then((savedData) => {
                    ...
                    let data = {
                        ...
                        'status': that.postStatus,
                        'topic_id': that.topic.id,
                        'admin_id': that.user.id
                    };
