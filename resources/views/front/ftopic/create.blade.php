...
<div class="content-grid">
    ...
    <div class="section-banner">
        ...
        <p class="section-banner-title">{!! $category->title !!}</p>
        <!-- /SECTION BANNER TITLE -->

        <!-- SECTION BANNER TEXT -->
        <p class="section-banner-text">Add a new forum topic</p>
        <!-- /SECTION BANNER TEXT -->
    </div>
    <!-- /SECTION BANNER -->
    ...
    <div class="section-header">
        ...
        <div class="section-header-info">
            ...
            <!-- SECTION TITLE -->
            <h2 class="section-title">Add a new topic</h2>
            <!-- /SECTION TITLE -->
        </div>
        <!-- /SECTION HEADER INFO -->
    </div>
    ...
    <div class="grid grid-8-4 small-space">
        ...
        <div class="grid-column">
            ...
            <div class="widget-box">
                <!-- WIDGET BOX TITLE -->
                <p class="widget-box-title">Topic Details</p>
                <!-- /WIDGET BOX TITLE -->

                <!-- WIDGET BOX CONTENT -->
                <div class="widget-box-content">
                    <!-- FORM -->
                    {!! Form::open(['route' => 'forum.topic.store', 'method' => 'POST', 'class' => 'form', 'novalidate' => 'novalidate', 'enctype' => 'multipart/form-data' ]) !!}
                    {!! Form::token() !!}
                        ...
                        <div class="form-row split">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-select">
                                    <label for="category-parent">Topic Category</label>
                                    {!! Form::select('fcategory_id', $categories, null, ['class' => '', 'required' => 'true', 'placeholder' => 'Select a forum category' ]) !!}
                                    <!-- FORM SELECT ICON -->
                    ...
                    <div class="form-row split">
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-select">
                                ...
                                {!! Form::select('status', ['True' => 'Open', 'False' => 'Closed'], null, ['class' => '', 'required' => 'true', 'placeholder' => 'Select status' ]) !!}
                                <!-- FORM SELECT ICON -->
                                <svg class="form-select-icon icon-small-arrow">
                                    <use xlink:href="#svg-small-arrow"></use>
                                </svg>
            ...
            <div class="sidebar-box">
                ...
                <div class="product-preview">
                    ...
                    <div class="product-preview-info">
                        ...
                        <!-- /TEXT STICKER -->
                        <p class="product-preview-title text-center">Topic Image</p>
