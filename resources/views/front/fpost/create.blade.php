...
<div class="content-grid">
    ...
    <div class="section-banner">
        ...
        <!-- SECTION BANNER TEXT -->
        <p class="section-banner-text">Add a new discussion</p>
        <!-- /SECTION BANNER TEXT -->
    </div>
    <!-- /SECTION BANNER -->
    ...
    <div class="section-header">
        ...
        <div class="section-header-info">
            <!-- SECTION PRETITLE -->
            <p class="section-pretitle">{!! $topic->title !!}</p>
            <!-- /SECTION PRETITLE -->
    ...
    <div class="grid grid-8-4 small-space">
        ...
        <div class="grid-column">
            ...
            <div class="widget-box">
                <!-- WIDGET BOX TITLE -->
                <p class="widget-box-title">Discussion Details</p>
                <!-- /WIDGET BOX TITLE -->

                <!-- WIDGET BOX CONTENT -->
                <div class="widget-box-content">
                    <!-- FORM -->
                    {!! Form::open(['route' => 'forum.post.store', 'method' => 'POST', 'class' => 'form', 'novalidate' => 'novalidate', 'enctype' => 'multipart/form-data' ]) !!}
                    {!! Form::token() !!}
